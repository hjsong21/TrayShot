...
public class ScreenshotConverterTests : IDisposable
{
    ...
    {
        string deleteTestPng = Path.Combine(Path.GetTempPath(), $"trayshot_del_{Guid.NewGuid():N}.png");
    ...
    public void NeedsWebpConversion_ReturnsFalseWhenWebpAlreadyExistsWithMatchingMTime()
    {
        ...
        bool needsReconversion = TrayShot.Models.ScreenshotFile.NeedsWebpConversion(_tempPngPath);
